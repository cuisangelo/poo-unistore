...
export class ApiService {
  ...
  loginByEmail(form: UsuarioRegister): Observable<UsuarioRespuesta> {
    return this.http.post<UsuarioRespuesta>('http://localhost:8080/loginByEmail', form, this.httpOptions)
      .pipe(
        retry(1),
        catchError(this.errorHandl)
      );
